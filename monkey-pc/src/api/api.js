...
//验证手机号是否存在（修改接口地址）
const checkOnlyMobile = params => getAction('/sys/user/checkOnlyUser', params)
...
const getDeptList = params => getAction('/unit/listUnit', params)
...
// 地图关键词查询
const getIndexMapCount = () => getAction('/homeCount/mapCount')
// 主页统计
const getHomeCountList = () => getAction('/homeCount/list')

// 获取机构列表
const getOrgList = () => postAction('/examineOrg/queryListByType')
//选择机构
const getChoiceOrg = params => getAction('/examineOrg/getChoiceOrg', params)
// 提交机构资料
const postOrgData = params => postAction('/examineOrg/dataUpload', params)
// 重新提交机构资料
const rePostOrgData = params => postAction('/examineOrg/dataRetransmission', params)
