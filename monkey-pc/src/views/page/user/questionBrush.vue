<template>
    <div class="home common-container">
        <el-row :gutter="40">
            <el-col :span="24">
                            ...
                            <el-row class="row-set">
                                <el-col :span="24">
                                    ...
                                    <!-- <el-cascader
                                        ...
                                        <el-input placeholder="请选择题目类型" readonly></el-input>
                                        <el-button @click="chooseBranshType = true">选择题目类型</el-button>
                                </el-col>
                            </el-row>
                            <el-row v-if="brushSet.topicType.length>0" class="row-set">
                                <el-col :span="24">
                                    <span>题目总数量：<el-link :underline="false">1234<i class="el-icon-view el-icon--right"></i> </el-link>
                                    <!-- <strong>123</strong> -->
                                    </span>
                ...
                <el-card class="mg-t-20 bransh-tabs">
                    <el-row class="topic-info">
                        ...
                        <el-col :span="2" class="collect">
                            ...
                            <!-- <el-button type="primary" size="mini" plain>收&nbsp;&nbsp;&nbsp;&nbsp;藏</el-button> -->
                            <el-button type="primary" size="mini" >已收藏</el-button>
    ...
    题库【公共题库，私人题库】：搜索框（知识点搜索、题目搜索；今日新增，总题目数量。可使用题目的编号搜索编号格式TM+10位数字。下滑固定在顶部）
        ...
        <el-dialog
            title="题目类型选择"
            :visible.sync="chooseBranshType"
            width="60%">
            <type-select></type-select>
            <span slot="footer" class="dialog-footer">
                <el-button @click="chooseBranshType = false">取 消</el-button>
                <el-button type="primary" @click="chooseBranshType = false">确 定</el-button>
            </span>
            </el-dialog>
    </div>
</template>
...
import TypeSelect from "@/components/tool/typeSelect"
export default {
    name: "Home",
    components:{
        aplayer,
